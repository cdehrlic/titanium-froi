...
function generateClaimPDF(formData, referenceNumber) {
  return new Promise(function(resolve, reject) {
    ...
    if (formData.additionalTreatmentNeeded === true) {
      const referral = formData.severeInjury === true && formData.employeeRequestsHospital === true ? 'Hospital (Severe + Employee Request)' : 'Urgent Care';
      addFieldRow([{ label: 'Additional Treatment Needed', value: 'Yes' }, { label: 'Referral', value: referral }]);
...
if(step===3)return e('div',{className:'step-content'},e('div',{className:'section-header'},e('h2',null,'Medical Treatment')),e('div',{className:'form-group'},e('label',null,'Sought Treatment?'),tog('soughtMedicalTreatment',[{v:true,l:'Yes'},{v:false,l:'No'}])),d.soughtMedicalTreatment===true?e('div',{className:'form-grid',style:{marginTop:16}},e('div',{className:'form-group full-width'},e('label',null,'Facility'),inp('facilityName','Hospital/Clinic')),e('div',{className:'form-group'},e('label',null,'Treatment Date'),inp('treatmentDate','','date'))):null,d.soughtMedicalTreatment===false?e('div',{className:'form-group',style:{marginTop:16}},e('label',null,'Refused Treatment?'),tog('refusedTreatment',[{v:true,l:'Yes, Refused',c:'warning'},{v:false,l:'N/A'}]),d.refusedTreatment===true?e('div',{className:'info-tip'},'💡 Get signed refusal form'):null):null,e('div',{style:{marginTop:20,borderTop:'1px solid rgba(139,148,158,0.2)',paddingTop:20}},e('div',{className:'form-group'},e('label',null,'Additional Treatment Needed?'),tog('additionalTreatmentNeeded',[{v:true,l:'Yes'},{v:false,l:'No'}])),d.additionalTreatmentNeeded===true?e('div',{style:{marginTop:16}},e('div',{className:'form-group'},e('label',null,'Is this a severe injury?'),tog('severeInjury',[{v:true,l:'Yes - Severe',c:'danger'},{v:false,l:'No'}])),d.severeInjury===true?e('div',{className:'form-group',style:{marginTop:12}},e('label',null,'Employee requesting hospital?'),tog('employeeRequestsHospital',[{v:true,l:'Yes',c:'warning'},{v:false,l:'No'}])):null,e('div',{className:'info-tip',style:{marginTop:12}},d.severeInjury===true&&d.employeeRequestsHospital===true?'🏥 Hospital referral appropriate - severe injury and employee request':'🏥 Refer to Urgent Care - standard protocol for non-severe injuries')):null));
