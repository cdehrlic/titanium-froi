...
const validateForm=()=>{const errs=[];if(!d.firstName)errs.push('Employee First Name');if(!d.lastName)errs.push('Employee Last Name');if(!d.entity&&!d.customEntity)errs.push('Entity');if(!d.dateOfInjury)errs.push('Date of Injury');if(!d.accidentDescription)errs.push('Incident Description');if(!d.injuryType)errs.push('Injury Type');if(!d.submitterName)errs.push('Your Name');if(!d.submitterEmail)errs.push('Your Email');return errs};
